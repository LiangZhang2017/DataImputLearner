...
def preprocess_oli_data(base_filename, input_data_dir):
    """
    ...
    filter_data = filter_data.sort_values(by=["Anon Student Id", "Problem Name", "Time"])
...
if __name__ == '__main__':
    ...
    # All base files: 
    # -------------------------------
    base_filename = "ds514_tx_All_Data_1694_2017_0227_040448"
    input_data_dir = os.path.join(os.getcwd(), "dataset", "source_dataset", "OLI")
    output_data_dir = os.path.join(os.getcwd(), "dataset", "dense_dataset", "OLI")
    ...
    # -------------------------------
    data, student_mapping, step_mapping = preprocess_oli_data(base_filename, input_data_dir)
    if data is None:
